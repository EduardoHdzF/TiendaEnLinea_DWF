...
import { ApiResponse } from '../../commons/_model/api-response';
...
export class InvoiceService {
  ...
  generateInvoice(): Observable<HttpResponse<ApiResponse>>{
    return this.http.post<HttpResponse<ApiResponse>>(api_dwb_uri + this.source, { observe: 'response'});
  }
}
